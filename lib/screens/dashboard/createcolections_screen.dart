...
class _CreatecolectionsScreenState extends State<CreatecolectionsScreen> {
  ...
  bool bordercolor_title = false;
  bool bordercolor_description = false;
  bool bordercolor_amount = false;
  bool bordercolor_deadline = false;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MouseRegion(
                        onEnter: (_) =>
                            setState(() => bordercolor_title = true),
                        onExit: (_) =>
                            setState(() => bordercolor_title = false),
                        child: InputField(
                          textEditingController: _title,
                          hint: 'e.g. School Reunin Contribution',
                          bordercolor: bordercolor_title
                              ? Colors.green
                              : Colors.transparent,
                        ),
                      ),
                      ...
                      MouseRegion(
                        onEnter: (_) =>
                            setState(() => bordercolor_description = true),
                        onExit: (_) =>
                            setState(() => bordercolor_description = false),
                        child: InputField(
                          textEditingController: _description,
                          hint: 'Describe what this contribution is for',
                          bordercolor: bordercolor_description
                              ? Colors.green
                              : Colors.transparent,
                        ),
                      ),
                      ...
                      MouseRegion(
                        onEnter: (_) =>
                            setState(() => bordercolor_deadline = true),
                        onExit: (_) =>
                            setState(() => bordercolor_deadline = false),
                        child: GestureDetector(
                          ...
                          child: AbsorbPointer(
                            child: InputField(
                              ...
                              bordercolor: bordercolor_deadline
                                  ? Colors.green
                                  : Colors.transparent,
                              suffixWidget: Icon(
                      ...
                      MouseRegion(
                        onEnter: (_) =>
                            setState(() => bordercolor_amount = true),
                        onExit: (_) =>
                            setState(() => bordercolor_amount = false),
                        child: InputField(
                          textEditingController: _amount,
                          hint: 'e.g. 2000',
                          bordercolor: bordercolor_amount
                              ? Colors.green
                              : Colors.transparent,
                        ),
                      ),
